            ...
            <div class="row">
                <div class="col-lg-6 col-md-6" style="margin-top: -10px;">
                    <div class="pull-left" style="color:#16a085;">
                        <h4><i class="fa fa-home"></i> SEMI-FINISHED PRODUCTION STAGE</h4>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable " style="font-size:13px;">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td>@if($order->status < 4) <button class="btn btn-danger btn-xs disabled">NOT COMPLETED</button>@elseif($order->quantity != $order->upholstery_quantity || $order->quantity != $order->sprayer_quantity )<button class="btn btn-danger btn-xs disabled">NOT COMPLETED</button>  @else <button class="btn btn-success disabled">COMPLETED</button>  @endif
